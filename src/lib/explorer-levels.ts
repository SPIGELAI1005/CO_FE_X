...
export const EXPLORER_LEVELS: ExplorerLevel[] = [
  { key: "rookie", min: 0, gradient: "from-slate-400 to-slate-600", Icon: Sprout },
  { key: "seeker", min: 50, gradient: "from-amber-300 to-amber-500", Icon: Search },
  { key: "hunter", min: 200, gradient: "from-orange-400 to-amber-700", Icon: Target },
  { key: "master", min: 500, gradient: "from-rose-400 to-amber-700", Icon: Coffee },
  { key: "nomad", min: 1500, gradient: "from-emerald-500 to-teal-700", Icon: Compass },
  { key: "legend", min: 5000, gradient: "from-fuchsia-500 via-amber-500 to-orange-700", Icon: Crown },
];
