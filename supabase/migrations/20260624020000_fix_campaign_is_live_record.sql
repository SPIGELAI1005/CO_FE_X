-- join_campaign selects c.* plus shop columns into a record; accept record not campaigns composite.
...
DECLARE
  ...
  _starts_at timestamptz := (_c).starts_at;
  _ends_at timestamptz := (_c).ends_at;
BEGIN
